...
const bulkUncategorizeBankTransactions = post<
...
class BulkUncategorizeBankTransactionsSWRResponse {
  ...
  constructor(swrResponse: BulkUncategorizeBankTransactionsSWRMutationResponse) {
...
export const useBulkUncategorizeBankTransactions = () => {
  ...
  const rawMutationResponse = useSWRMutation(
    ...
    (
      ...
      return bulkUncategorizeBankTransactions(
        apiUrl,
        accessToken,
        {
          params: { businessId },
