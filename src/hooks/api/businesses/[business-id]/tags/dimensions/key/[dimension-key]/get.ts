...
import { TagDimensionSchema } from '@schemas/features/tags/tagDimension'
...
export const useGetTagDimensionByKey = createQueryHook({
...
export function usePreloadTagDimensionByKey(parameters: UseTagDimensionByKeyParameters) {
   ...
   */
  useGetTagDimensionByKey(parameters)
}
