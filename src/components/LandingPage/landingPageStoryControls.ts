...
export function buildHeroOverrides({
  heroTitle,
  heroSubtitle,
  heroHeading1,
  heroHeading1Desc,
...
function buildCardOverrides(card: {
  badge: string
  title: string
  subtitle: string
  priceAmount: string
...
export function buildOfferingOverrides(args: LandingPageStoryArgs): LandingPageProps['offeringOverrides'] {
  return {
...
export const landingPageStoryControlsInclude = [
...
export const landingPageStoryDefaultArgs: LandingPageStoryArgs = {
  platformName: 'Acme',
  ...
  // Calendly's public demo scheduling page renders the real widget in Storybook.
  bookkeepingCtaUrl: 'https://calendly.com/calendly-demo',
}

export const landingPageStoryArgTypes: Meta<LandingPageStoryArgs>['argTypes'] = {
  platformName: {
