      ...
      <VStack gap='sm'>
        ...
        >
          <BankTransactionReceipts
            label={t('bankTransactions:BankTransactionsMobileList.BankTransactionsMobileListBusinessForm.label.receipts', 'Receipts')}
            ref={receiptsRef}
        ...
        <HStack gap='xs'>
          <FileInput
            ...
            text={t('bankTransactions:BankTransactionsMobileList.BankTransactionsMobileListBusinessForm.action.upload_receipt', 'Upload receipt')}
            icon
        ...
        {isErrorCategorizing && showRetry
          ? (
            <ErrorText size='sm' align='center' pb='sm'>
              {t('bankTransactions:BankTransactionsMobileList.BankTransactionsMobileListBusinessForm.error.approval_failed_check_connection', 'Approval failed. Check connection and retry in a few seconds.')}
            </ErrorText>
          )
          : null}
      </VStack>
