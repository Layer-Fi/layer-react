        ...
        <VStack gap='sm'>
          <VStack gap='3xs'>
            <Span size='sm' weight='bold'>
              {t('bankTransactions:BankTransactionsMobileList.action.split_transaction', 'Split transaction')}
            </Span>
            <VStack gap='sm'>
          ...
          <HStack align='end'>
            ...
            <Button onClick={addSplit} variant='outlined'>
              <HStack align='center' gap='2xs' pis='2xs' pie='2xs'>
                {t('bankTransactions:BankTransactionsMobileList.action.split_label', 'Split')}
                <Scissors size={14} />
              </HStack>
            </Button>
          </HStack>
