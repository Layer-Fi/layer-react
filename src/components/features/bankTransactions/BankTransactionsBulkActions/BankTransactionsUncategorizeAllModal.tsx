...
export const BankTransactionsUncategorizeAllModal = ({ isOpen, onOpenChange, isMobileView = false }: BankTransactionsUncategorizeAllModalProps) => {
  ...
  return (
    <BaseConfirmationModal
      ...
      title={t('bankTransactions:BankTransactionsBulkActions.prompt.uncategorize_selected_transactions', 'Uncategorize all selected transactions?')}
      content={(
        <Span>
          {tPlural(t, 'bankTransactions:BankTransactionsBulkActions.label.uncategorize_count_selected', {
            count,
      ...
      confirmLabel={t('bankTransactions:BankTransactionsBulkActions.action.uncategorize_all', 'Uncategorize All')}
      errorText={t('bankTransactions:BankTransactionsBulkActions.error.uncategorize_transactions', 'Failed to uncategorize transactions')}
