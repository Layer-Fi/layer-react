  ...
  return (
    <HStack gap='md' pi='md' pb='md' align='center'>
      <Checkbox
        ...
        aria-label={t('bankTransactions:BankTransactionsList.BankTransactionsListSelectAllHeader.label.select_all_transactions', 'Select all transactions on this page')}
      />
      <Span size='sm'>
