                ...
                <VStack gap='md' align='center' className='empty-state'>
                  <P variant='subtle' align='center' size='sm'>
                    {direction === LedgerEntryDirection.Debit
                      ? t('generalLedger:JournalEntryForm.empty.debit_line_items', 'No debit line items added yet. Click "Add next line" to get started.')
                      : t('generalLedger:JournalEntryForm.empty.credit_line_items', 'No credit line items added yet. Click "Add next line" to get started.')}
                  </P>
                </VStack>
              )}
              {!isReadOnly && (
                <HStack justify='start'>
                  <Button onPress={() => field.pushValue(getJournalEntryLineItemFormDefaultValues(direction))} variant='text'>
                    <Span weight='normal' size='sm' variant='subtle'>
                      {t('generalLedger:JournalEntryForm.action.add_next_line', 'Add next line')}
                    </Span>
                  </Button>
                </HStack>
              )}
