...
import { sumLineItemAmountsByDirection } from '@utils/features/generalLedger/journal'
...
export const LedgerEntryDetailsLineItemsTable = ({
  ...
  const columnConfig = useMemo<ColumnConfig<LineItemRow>>(() => [
    {
      id: 'account',
      header: stringOverrides?.lineItemsColumnHeader || t('generalLedger:LedgerEntryDetails.LedgerEntryDetailsLineItemsTable.label.line_items', 'Line items'),
      isRowHeader: true,
  ...
  const slots = useMemo(() => ({
    EmptyState: () => (
      <DataState
        ...
        title={t('generalLedger:LedgerEntryDetails.LedgerEntryDetailsLineItemsTable.empty.line_items', 'No line items')}
        description={t('generalLedger:LedgerEntryDetails.LedgerEntryDetailsLineItemsTable.empty.line_items_description', 'This entry has no line items.')}
        spacing
      />
    ),
    ErrorState: () => (
