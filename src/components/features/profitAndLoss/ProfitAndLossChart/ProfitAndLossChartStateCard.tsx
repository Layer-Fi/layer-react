  ...
  return (
    <div className='Layer__profit-and-loss-chart__state-card'>
      ...
      <div className='Layer__profit-and-loss-chart__state-card__text'>
        <P weight='bold'>{t('profitAndLoss:ProfitAndLossChart.ProfitAndLossChartStateCard.label.data_is_syncing', 'Data is syncing')}</P>
        <P size='sm' align='center'>
          {t('profitAndLoss:ProfitAndLossChart.ProfitAndLossChartStateCard.label.may_take_few_minutes', 'This may take a few minutes')}
        </P>
      </div>
    </div>
  )
