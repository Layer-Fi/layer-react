...
import {
  ...
  ReportsTableRow,
} from '@features/reports/ReportsTable/ReportsTable'
          ...
          <ReportsTableBody>
            ...
            {renderLineItem({
              lineItem: {
                ...
                displayName:
                  stringOverrides?.profitBeforeTaxesLabel || t('profitAndLoss:ProfitAndLossTable.label.profit_before_taxes', 'Profit Before Taxes'),
                lineItems: [],
              },
              depth: 0,
