...
export const FullYearProjectionComboBox = () => {
  ...
  const options = useMemo<ProjectionOption[]>(
    () => [
      { label: t('taxEstimates:FullYearProjectionComboBox.label.year_to_date', 'Year to date'), value: 'ytd', valueBool: false },
      { label: t('taxEstimates:FullYearProjectionComboBox.label.full_year_projection', 'Full year projection'), value: 'full-year', valueBool: true },
    ],
    [t],
  )
