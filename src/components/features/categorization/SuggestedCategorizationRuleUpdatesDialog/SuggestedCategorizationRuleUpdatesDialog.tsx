...
import { RuleSuggestionHeader, SuggestedCategorizationRuleUpdates } from '@features/categorization/SuggestedCategorizationRuleUpdates/SuggestedCategorizationRuleUpdates'
...
export const SuggestedCategorizationRuleUpdatesDialog = ({
  ...
  return (
    <Modal flexBlock isOpen={isOpen} onOpenChange={onOpenChange} aria-label={t('categorization:SuggestedCategorizationRuleUpdatesDialog.label.update_categorization_rules', 'Update categorization rules')}>
      {({ close }) => (
        <>
