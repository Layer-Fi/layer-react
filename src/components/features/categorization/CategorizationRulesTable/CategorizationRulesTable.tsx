...
import type { NestedCategorization } from '@schemas/categorization/categorization'
...
import { ResolvedCategoryName } from '@features/categorization/ResolvedCategoryName/ResolvedCategoryName'
