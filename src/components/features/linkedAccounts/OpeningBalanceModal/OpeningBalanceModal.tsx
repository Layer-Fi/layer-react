...
import { OpeningBalanceAccountForm, type OpeningBalanceAccountFormData } from '@features/linkedAccounts/OpeningBalanceAccountForm/OpeningBalanceAccountForm'
...
function ignoreAlreadySaved(
  formsData: OpeningBalanceAccountFormData[],
  results: ResultsState,
) {
...
function LinkedAccountsOpeningBalanceModalContent({
  ...
  const [formsData, setFormsData] = useState<OpeningBalanceAccountFormData[]>(accounts.map(item => (
    {
      bankAccount: item,
      isConfirmed: true,
