...
import { VehicleCard } from '@features/mileage/VehicleCard/VehicleCard'

import './vehiclesGrid.scss'
...
export const VehiclesGrid = ({ onEditVehicle, showArchived }: VehiclesGridProps) => {
  ...
  return (
    <HStack className='Layer__VehiclesGrid'>
