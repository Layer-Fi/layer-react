...
import { useCurrentTripsPage, useTripsTableFilters } from '@providers/features/mileage/TripsRouteStore/TripsRouteStoreProvider'
import { type DefaultVariant, ResponsiveComponent } from '@components/utility/ResponsiveComponent'
import { DataState, DataStateStatus } from '@ui/DataState/DataState'
import { TripDeleteConfirmationModal } from '@features/mileage/TripDeleteConfirmationModal/TripDeleteConfirmationModal'
import { TripDrawer } from '@features/mileage/TripDrawer/TripDrawer'
...
const TripsViewEmptyState = () => {
  ...
  return (
    <DataState
      ...
      title={t('mileage:TripsView.empty.no_trips_yet', 'No trips yet')}
      description={t('mileage:TripsView.empty.add_first_trip', 'Add your first trip to start tracking mileage.')}
      icon={<Car />}
      spacing
...
const TripsViewErrorState = () => {
  ...
  return (
    <DataState
      ...
      title={t('mileage:TripsView.error.load_trips', 'We couldn’t load your trips')}
      description={t('mileage:TripsView.error.load_trips_error', 'An error occurred while loading your trips. Please check your connection and try again.')}
      spacing
