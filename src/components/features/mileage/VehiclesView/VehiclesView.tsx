...
import { useTripsNavigation } from '@providers/features/mileage/TripsRouteStore/TripsRouteStoreProvider'
...
interface VehiclesViewHeaderProps {
  onAddVehicle: () => void
...
const MobileVehiclesViewHeader = ({
  onAddVehicle,
}: VehiclesViewHeaderProps) => {
...
const DesktopVehiclesViewHeader = ({
  onAddVehicle,
  showArchived,
...
export const VehiclesView = () => {
  const { t } = useTranslation()
  const { toTrips } = useTripsNavigation()
  ...
  return (
    <>
      ...
      >
        ...
        <VehiclesGrid onEditVehicle={handleEditVehicle} showArchived={showArchived} />
      </BaseDetailView>
      <VehicleDrawer
