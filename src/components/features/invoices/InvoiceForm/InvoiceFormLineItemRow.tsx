  ...
  return (
    <VStack>
      ...
      >
        ...
        >
          {field => <field.FormNonRecursiveBigDecimalField label={t('invoices:InvoiceForm.label.quantity', 'Quantity')} showLabel={index === 0} isReadOnly={isReadOnly} />}
        </form.AppField>
        <form.AppField
        ...
        >
          {field => <field.FormNonRecursiveBigDecimalField label={t('invoices:InvoiceForm.label.rate', 'Rate')} mode='currency' showLabel={index === 0} allowNegative isReadOnly={isReadOnly} />}
        </form.AppField>
        <form.AppField
        ...
        <form.AppField name={`lineItems[${index}].isTaxable`}>
          {field => <field.FormCheckboxField label={t('invoices:InvoiceForm.label.taxable', 'Taxable')} showLabel={index === 0} align='center' isReadOnly={isReadOnly} />}
        </form.AppField>
        {!isReadOnly
