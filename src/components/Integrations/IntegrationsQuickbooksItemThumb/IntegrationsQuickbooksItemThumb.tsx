  ...
  switch (quickbooksUiState) {
    case QuickbooksConnectionSyncUiState.SyncFailed: {
      return {
        ...
        ...translationKey('integrations:action.retry_sync', 'Retry Sync'),
      } as const
    }
    ...
    case QuickbooksConnectionSyncUiState.SyncSuccess: {
      return {
        ...
        ...translationKey('integrations:state.synced', 'Synced'),
      } as const
    }
    default:
...
export const IntegrationsQuickbooksItemThumb = () => {
  ...
  const menuConfig = useMemo(() => {
    return [
      {
        name: t('linkedAccounts:action.unlink_account', 'Unlink account'),
        action: () => {
