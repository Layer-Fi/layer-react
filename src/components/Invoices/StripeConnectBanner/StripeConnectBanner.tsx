...
export const StripeConnectBanner = () => {
  ...
  const bannerPropConfig = useMemo<Partial<Record<StripeAccountStatus, {
    ...
    [StripeAccountStatus.Pending]: {
      variant: 'default',
      title: t('stripe:stripeAccountUnderReview', 'Stripe account under review'),
      description: t('stripe:onceCompleteYouCanStartAcceptingCardAndBankPayments', 'Once complete, you can start accepting card and bank payments.'),
    },
    [StripeAccountStatus.NotCreated]: {
      variant: 'info',
      title: t('stripe:stripePaymentsNotEnabled', 'Stripe payments not enabled'),
      description: t('stripe:setUpYourStripeAccountToStartAcceptingCardAndBankPaymentsForYourInvoices', 'Set up your Stripe account to start accepting card and bank payments for your invoices.'),
    },
    [StripeAccountStatus.Incomplete]: {
      variant: 'warning',
      title: t('stripe:stripeSetupIncomplete', 'Stripe setup incomplete'),
      description: t('stripe:finishSettingUpYourStripeAccountToStartAcceptingCardAndBankPaymentsForYourInvoices', 'Finish setting up your Stripe account to start accepting card and bank payments for your invoices.'),
    },
  }), [t])
