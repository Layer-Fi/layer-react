...
import { type CategorizationRuleFormApi } from '@components/CategorizationRules/CategorizationRuleForm/useCategorizationRuleForm'
import { FieldErrors } from '@components/forms/FieldErrors'

import './categorizationRuleForm.scss'

export type CategorizationRuleFormFieldsProps = PropsWithChildren<{
  form: CategorizationRuleFormApi
  formState: CategorizationRuleFormState
}>

export const CategorizationRuleFormFields = ({ form, formState, children }: CategorizationRuleFormFieldsProps) => {
