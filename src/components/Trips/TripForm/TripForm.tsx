  ...
  return (
    <Form className='Layer__TripForm' onSubmit={blockNativeOnSubmit}>
      ...
      <form.AppField name='tripDate'>
        {field => (
          <field.FormDateField<CalendarDate>
            label={t('trips:tripDate', 'Trip date')}
            inline
      ...
      <form.AppField name='distance'>
        {field => (
          <field.FormBigDecimalField
            label={t('trips:distanceMiles', 'Distance (miles)')}
            inline
            isReadOnly={isReadOnly}
            maxDecimalPlaces={2}
            placeholder={t('trips:enterDistance', 'Enter distance')}
      ...
      <form.AppField name='startAddress'>
        {field => (
          <field.FormTextField
            label={t('trips:startAddress', 'Start address')}
            inline
            isReadOnly={isReadOnly}
            placeholder={t('trips:enterAddress', 'Enter address')}
      ...
      <form.AppField name='endAddress'>
        {field => (
          <field.FormTextField
            label={t('trips:endAddress', 'End address')}
            inline
            isReadOnly={isReadOnly}
            placeholder={t('ui:enterAddress', 'Enter address')}
      ...
      <form.Field name='vehicle'>
        {field => (
          <VehicleSelector
            ...
            isReadOnly={isReadOnly}
            inline
            placeholder={t('vehicles:addVehicleLabel', 'Add vehicle')}
