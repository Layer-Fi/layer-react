...
import { type ListTimeEntriesFilterParams, useGetInfiniteTimeEntries } from '@api/businesses/[business-id]/time-tracking/time-entries/get'
...
const TimeEntriesContent = ({ filterParams }: Pick<TimeEntriesProps, 'filterParams'>) => {
  ...
  const { data, flattenedData: entries, isLoading, isError, hasMore, fetchMore } = useGetInfiniteTimeEntries(timeEntriesFilterParams)
