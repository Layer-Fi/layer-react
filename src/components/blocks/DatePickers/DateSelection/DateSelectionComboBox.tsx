...
import { DatePreset, type SelectableDatePreset } from '@utils/shared/date/dateRangePresets'
...
export const DateSelectionComboBox = ({
  ...
  const label = t('blocks:DateSelection.DateSelectionComboBox.label.report_period', 'Report period')
