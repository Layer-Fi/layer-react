...
export interface NestedApiLedgerAccount extends Schema.Struct.Type<typeof nestedLedgerAccountFields> {
  subAccounts: ReadonlyArray<NestedApiLedgerAccount>
}

export interface NestedApiLedgerAccountEncoded extends Schema.Struct.Encoded<typeof nestedLedgerAccountFields> {
  readonly sub_accounts: ReadonlyArray<NestedApiLedgerAccountEncoded>
}

export const NestedApiLedgerAccountSchema = Schema.Struct({
  ...nestedLedgerAccountFields,
  subAccounts: pipe(
    Schema.propertySignature(Schema.Array(
      Schema.suspend((): Schema.Schema<NestedApiLedgerAccount, NestedApiLedgerAccountEncoded> => NestedApiLedgerAccountSchema),
    )),
...
export interface NestedApiChartAccount extends Schema.Struct.Type<typeof nestedChartAccountFields> {
  subAccounts: ReadonlyArray<NestedApiChartAccount>
}

export interface NestedApiChartAccountEncoded extends Schema.Struct.Encoded<typeof nestedChartAccountFields> {
  readonly sub_accounts: ReadonlyArray<NestedApiChartAccountEncoded>
}

export const NestedApiChartAccountSchema = Schema.Struct({
  ...nestedChartAccountFields,
  subAccounts: pipe(
    Schema.propertySignature(Schema.Array(
      Schema.suspend((): Schema.Schema<NestedApiChartAccount, NestedApiChartAccountEncoded> => NestedApiChartAccountSchema),
    )),
    Schema.fromKey('sub_accounts'),
  ),
})

export type NestedApiLedgerAccountType = typeof NestedApiLedgerAccountSchema.Type
export type NestedApiChartAccountType = typeof NestedApiChartAccountSchema.Type
