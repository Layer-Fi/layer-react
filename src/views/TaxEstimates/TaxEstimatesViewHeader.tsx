...
import { TaxEstimatesRoute, useTaxEstimatesNavigation, useTaxEstimatesYear } from '@providers/features/taxEstimates/TaxEstimatesRouteStore/TaxEstimatesRouteStoreProvider'
...
export const TaxEstimatesViewHeader = () => {
  ...
  return (
    <HStack gap='xs'>
      ...
      />
      <DropdownMenu
        ariaLabel={t('views:TaxEstimates.label.additional_actions', 'Additional actions')}
        slots={{ Trigger }}
      ...
      >
        <MenuList>
          <MenuItem key={TaxEstimatesRoute.Profile} onClick={() => { navigate.toProfile() }}>
            ...
            <Span size='sm'>{t('views:TaxEstimates.action.update_tax_profile', 'Update tax profile')}</Span>
          </MenuItem>
        </MenuList>
      </DropdownMenu>
    </HStack>
