...
import { TaxEstimatesRouteStoreProvider, type TaxEstimatesRouteStoreProviderExternalHooks } from '@providers/TaxEstimatesRouteStore/TaxEstimatesRouteStoreProvider'
...
export type TaxEstimatesProps = PropsWithChildren<TaxEstimatesRouteStoreProviderExternalHooks>

export const TaxEstimates = ({ onClickReviewTransactions: onReviewClicked }: TaxEstimatesProps) => {
  return (
    <TaxEstimatesRouteStoreProvider external={{ onClickReviewTransactions: onReviewClicked }}>
      <TaxEstimatesView />
