...
export const NoTaxProfileBanner = ({ onSetupTaxProfile }: NoTaxProfileBannerProps) => {
  ...
  const title = t('views:SolopreneurOverview.label.set_up_your_tax_profile', 'Set up your tax profile')
  const description = t('views:SolopreneurOverview.label.set_up_your_tax_profile_description', 'Configuring your tax profile allows us to provide you with tax estimates and avoid any surprises come tax time.')
