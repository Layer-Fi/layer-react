...
import type { DateSelectionMode } from '@providers/DateStore/GlobalDateStore/GlobalDateStoreProvider'
...
const PROJECT_TAB_CONFIG = [
  { value: 'overview' as const, ...translationKey('common:label.overview', 'Overview') },
  { value: 'transactions' as const, ...translationKey('common:label.transactions', 'Transactions') },
  { value: 'report' as const, ...translationKey('common:label.report', 'Report') },
]
    ...
    >
      <HStack className='Layer__component' gap='sm' align='center' justify='space-between'>
        ...
        <Select
          ...
          placeholder={t('common:action.select_a_project', 'Select a project...')}
