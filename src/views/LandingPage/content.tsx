...
const TEXT_CONTENT_I18N = {
  [LandingPageContentID.subtitle]: translationKey('views:LandingPage.content.label.track_business_finances_within_platform', 'Track your business finances, right within {{platformName}}.'),
  [LandingPageContentID.headline1]: translationKey('views:LandingPage.content.label.all_finances_in_one_place', 'All your finances in one place'),
  [LandingPageContentID.headline1Desc]: translationKey('views:LandingPage.content.label.directly_integrated_with_platform_name', 'Directly integrated with your {{platformName}} data, so you can see your business performance and profit in real-time.'),
  [LandingPageContentID.headline2]: translationKey('views:LandingPage.content.label.built_for_industry', 'Built for {{industry}}'),
  [LandingPageContentID.headline2Desc]: translationKey('views:LandingPage.content.label.track_expenses_and_get_reports', 'Track your expenses and get easy to understand reports designed specifically for {{industry}} businesses.'),
  [LandingPageContentID.valuePropositionTitle]: translationKey('views:LandingPage.content.label.self_service_accounting_business_health', 'Self-service accounting to understand your business health'),
  [LandingPageContentID.offersTitle]: translationKey('views:LandingPage.content.label.use_platform_name_accounting', 'Use {{platformName}} Accounting yourself, or let our team of experts handle bookkeeping for you'),
} as const
...
const HERO_CONTENT_I18N = {
  title: translationKey('views:LandingPage.content.label.platform_name_accounting', '{{platformName}} Accounting'),
  subtitle: translationKey('views:LandingPage.content.label.track_business_finances_within_platform', 'Track your business finances, right within {{platformName}}.'),
  heading1: translationKey('views:LandingPage.content.label.all_finances_in_one_place', 'All your finances in one place'),
  heading1Desc: translationKey('views:LandingPage.content.label.directly_integrated_with_platform_name', 'Directly integrated with your {{platformName}} data, so you can see your business performance and profit in real-time.'),
  heading2: translationKey('views:LandingPage.content.label.built_for_industry', 'Built for {{industry}}'),
  heading2Desc: translationKey('views:LandingPage.content.label.track_expenses_and_get_reports', 'Track your expenses and get easy to understand reports designed specifically for {{industry}} businesses.'),
  bookACall: translationKey('views:LandingPage.content.action.book_call', 'Book a call'),
  learnMore: translationKey('views:LandingPage.content.action.learn_more', 'Learn more'),
} as const
...
const ACCOUNTING_OFFERING_I18N = {
  badge: translationKey('views:LandingPage.content.label.easy_to_use_software', 'Easy to use software'),
  title: translationKey('views:LandingPage.content.label.platform_name_accounting', '{{platformName}} Accounting'),
  subtitle: translationKey('views:LandingPage.content.label.best_accounting_software_for_industry', 'The best accounting software for {{industry}} businesses. Fast to set up and easy to use.'),
} as const
...
const BOOKKEEPING_OFFERING_I18N = {
  badge: translationKey('views:LandingPage.content.label.complete_bookkeeping_service', 'A complete bookkeeping service'),
  title: translationKey('views:LandingPage.content.label.full_service_bookkeeping', 'Full-service Bookkeeping'),
  subtitle: translationKey('views:LandingPage.content.label.get_dedicated_bookkeeper', 'Get a dedicated bookkeeper who will organize and manage your books for you.'),
} as const
...
const DEFAULT_FEATURES_I18N = [
  {
    title: translationKey('views:LandingPage.content.label.all_finances_in_one_place', 'All your finances in one place'),
    text: translationKey('views:LandingPage.content.label.directly_integrated_with_platform_name', 'Directly integrated with your {{platformName}} data, so you can see your business performance and profit in real-time.'),
  },
  {
    title: translationKey('views:LandingPage.content.label.built_for_industry', 'Built for {{industry}}'),
    text: translationKey('views:LandingPage.content.label.track_expenses_and_get_reports', 'Track your expenses and get easy to understand reports designed specifically for {{industry}} businesses.'),
  },
] as const
