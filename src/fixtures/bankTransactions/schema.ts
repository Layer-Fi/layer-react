...
// externalAccountId is only set on recorded custom transactions, never on generated ones.
const { externalAccountId: _externalAccountId, ...fields } = BankTransactionSchema.fields
