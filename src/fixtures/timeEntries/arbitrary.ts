...
import { commonDurationsMinutes, timeEntryDescriptions, timeEntryMemos } from '@fixtures/timeEntries/constants'
...
export const timeEntryCustomerArbitrary = nullableConstantFrom(
  customerPool,
